...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <img id="background" class="absolute  top-0" src="/cartoonorksbg.png"/>
        <div
            class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <img src="/images/android-chrome-512x512.png" class="block h-[100px] w-auto float-left">
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        >
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#b9b1b0] sm:size-16">
                                <img src="/images/android-chrome-512x512.png"
                                     class="block h-[55px] w-[55px] float-left">
                            </div>
